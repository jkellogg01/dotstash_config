...
theme.font_h0 = theme.font_name .. " " .. tostring(dpi(6))
theme.font_h1 = theme.font_name .. " " .. tostring(dpi(8))
theme.font_h2 = theme.font_name .. " " .. tostring(dpi(12))
theme.font_h3 = theme.font_name .. " " .. tostring(dpi(18))
...
theme.border_marked = colors.aurora.yellow
